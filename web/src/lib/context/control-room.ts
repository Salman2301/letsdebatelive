...
type ContextTypes = {
  ...
  ctx_table$live_debate_participants_backstage: Readable<Tables<"live_debate_participants">[] | null>;
...
export function setControlRoomCtx<T extends keyof ContextTypes>(setCtx: typeof setContext, key: T, value: ContextTypes[T]): void {
  return setCtx(key, value) as any;
}

export function getControlRoomCtx<T extends keyof ContextTypes>(getCtx: typeof getContext, key: T): ContextTypes[T] {
