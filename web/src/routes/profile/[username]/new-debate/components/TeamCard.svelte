...
<div class="team-card">
	...
	<div class="participants-list">
		...
		{:else}
			<div
				class="flex items-center w-full mt-10 justify-center flex-col gap-4 bg-secondary-dark/40 py-2 rounded"
			>
				...
				<Button
					...
					color="secondary"
					fillType="dark"
					onclick={() => newToast({ type: 'error', message: 'Not implemented!' })}
				>
					<svg
						slot="icon-left"
						width="15"
