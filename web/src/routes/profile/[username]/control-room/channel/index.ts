...
export function emitBroadcastEvent(supabase: SupabaseClient, event: BroadcastEvent, liveDebateId: string, payload = {}) {
...
export function emitSceneChange(supabase: SupabaseClient, liveDebateId: string, payload: ScenePayload) {
