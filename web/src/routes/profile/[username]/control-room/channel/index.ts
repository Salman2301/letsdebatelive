...
export function emitBroadcastEvent(supabase: SupabaseClient, event: BroadcastEvent, hostId: string, payload = {}) {
...
export function emitSceneChange(supabase: SupabaseClient, hostId: string, payload: ScenePayload) {
  if (!hostId) throw new Error("Invalid host id!");
