<script lang="ts">
	...
	async function handleSubmit() {
		...
		if (settingForm.maxParticipant !== $live_debate.max_participants) {
			...
			{#each $teams as team}
				<div class="team-item-container">
					...
					<div class="team-input-container">
						...
						<button class="in-submit" class:hidden={team}>
							<CheckMark />
						</button>
						<button class="btn-team-default" class:active={team.slug === 'team-b'}>Default</button>
					</div>
